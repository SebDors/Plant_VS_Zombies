...
public class PlantDTO {
    ...
    public PlantDTO(int id, String nom, int point_de_vie, int cout, int degat_attaque, int attaque_par_seconde, int soleil_par_seconde, String effet, String chemin_image) {
        this.id = id;
        this.nom = nom;
